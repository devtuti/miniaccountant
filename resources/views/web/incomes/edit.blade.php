<div class="modal fade bs-example-modal-lg" id="editIncome" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <form class="form-horizontal form-label-left" method="POST">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9 col-sm-9 ">
                  <select class="select2_single form-control" tabindex="-1" name="transition">
