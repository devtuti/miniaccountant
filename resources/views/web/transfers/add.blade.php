<div class="modal fade bs-example-modal-lg" id="addTransfer" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <form class="form-horizontal form-label-left" method="POST">
            ...
            <div class="form-group row ">
                ...
                <div class="col-md-9 col-sm-9 ">
                    <input type="text" class="form-control" name="card_no" placeholder="My card no">
                </div>
            </div>
