<div class="modal fade bs-example-modal-lg" id="editPayment" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-body">
          <form class="form-horizontal form-label-left" method="POST">
            ...
            <div class="form-group row">
              <label class="control-label col-md-3 col-sm-3 ">Select exspenses</label>
